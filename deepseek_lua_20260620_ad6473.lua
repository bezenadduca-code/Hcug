...
-- FIXED: Config system now uses WindUI ConfigManager (same as Hutao)
...
-- Create ConfigManager (same as Hutao)
...
secLMS:Toggle({ Title="Auto-Play on LMS", Type="Checkbox", Flag="musicOn", Default=music.on, Callback=function(on)
    music.on = on; 
    if on then
...
secLMS:Dropdown({ Title="Track", Flag="musicSel", Values=musicList, Value=music.selected, Callback=function(sel)
...
-- ============================================================================
-- APPLY CONFIG FROM FLAGS (same method as Hutao)
-- ============================================================================
...
-- ============================================================================
-- AUTO-SAVE LOOP (same as Hutao)
-- ============================================================================
task.spawn(function()
    while true do
        task.wait(2)
        pcall(function() v1prConfig:Save() end)
    end
end)

-- ============================================================================
-- INITIAL CONFIG LOAD (same as Hutao)
-- ============================================================================
task.spawn(function()
    task.wait(1.5)
    ...
    task.defer(function()
        ...
        if win and win.Flags then
            ...
            print("[v1prware] win.Flags not yet available, skipping initial load")
        end
    end)
end)

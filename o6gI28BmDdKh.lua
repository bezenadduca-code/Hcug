...
local function combatHDTBeginDrag(killerModel, blockTrack)
    pcall(function()
        ...
        -- Freeze the sprint module so it cannot write WalkSpeed back during drag
        local sprintMod = nil
        ...
        local function stopMove()
            ...
            stopped = true
            -- Restore sprint module first so it doesnt snap speed on restore
            pcall(function()
                if sprintMod then
        ...
        -- Let MoveTo run at hdt speed with nothing fighting it
